    ...
    <div className="space-y-6">
                  ...
                  {isChecked && (
                    <div className="mt-2 max-w-xs">
                      <YearMonthSelect
                        ...
                        onYearChange={(value) => setYearMonthCombined("lungeAtmung", item.key, "jahr", { year: value })}
                        onMonthChange={(value) => setYearMonthCombined("lungeAtmung", item.key, "jahr", { month: value })}
                        showMonth={true}
                        birthYear={birthYear}
                      />
                    </div>
      ...
      <div className="border rounded-lg p-4 bg-muted/30">
        ...
        <Textarea
          ...
          value={(formData.lungeAtmung as any)?.sonstige || ""}
          onChange={(e) => updateSectionField("lungeAtmung", "sonstige", e.target.value)}
          className="mt-2"
          rows={2}
        />
      </div>
